...
replace (
	...
	github.com/openshift/installer => github.com/bitoku/installer v0.0.0-20231129113407-f9d22d1b7e6b
	...
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20231121142620-612c6f6bfa3c
